        ...
        <div className="p-8 space-y-8 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="space-y-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-3xl font-black text-slate-900 tracking-tight uppercase italic">Quản Lý Người Dùng</h1>
                            <p className="text-slate-500 font-medium flex items-center gap-2 mt-0.5">
                                <Shield className="h-4 w-4 text-primary/60" />
                                Kiểm soát quyền truy cập và trạng thái tài khoản hệ thống
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="bg-white p-4 rounded-[2rem] border border-slate-100 shadow-sm flex flex-col md:flex-row items-center gap-6">
                <div className="w-full md:w-48 shrink-0">
                    <Select value={roleFilter} onValueChange={setRoleFilter}>
                        ...
                        <SelectContent className="rounded-2xl border-slate-100 shadow-xl">
                            ...
                            <SelectItem value="quan_tri" className="font-bold py-3 rounded-xl">Quản trị viên</SelectItem>
                            <SelectItem value="khach_hang" className="font-bold py-3 rounded-xl">Khách hàng</SelectItem>
                        </SelectContent>
                    </Select>
                </div>
                ...
                <div className="relative w-full group">
                    ...
                    <Input
                        ...
                        className="pl-11 h-12 bg-slate-50 border-slate-100 rounded-2xl font-bold focus-visible:ring-primary/20 focus-visible:border-primary/30 transition-all font-medium"
                        value={search}
            ...
            {isLoading ? (
                <div className="h-[400px] flex flex-col items-center justify-center gap-4 bg-white rounded-3xl border border-dashed border-slate-200">
                    ...
                    <p className="text-slate-400 font-black animate-pulse uppercase tracking-widest text-[10px]">Đang truy xuất danh sách thành viên...</p>
                </div>
            ) : (
